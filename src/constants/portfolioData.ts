...
export const projectsData: Project[] = [
  ...
  },
  {
    ...
    description: "Responsive social media platform with posts, stories, and user suggestions using React.",
    longDescription: "Built a fully responsive social media platform using React.js with features like posts, stories, and user suggestions. Implemented state management and client-side routing for a smooth user experience. The platform features a modern UI with real-time interactions, mobile-first design, and JSON Server as a mock backend.",
